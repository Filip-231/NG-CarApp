...
from myapp.views import create_car, update_rating, avg_rating_of_rating
import json
import requests
import random as r
...
class test_functions(TestCase):
    """
    Testing function which creates views.
    to run every test:
    ...
    def test_create(self):
        # python manage.py test myapp.tests.test_functions.create
    ...
    def test_update_rating(self):
        ...
        rating1 = Rating.objects.get(Car=1)
        rating2 = Rating.objects.get(Car=2)

        avg_rating1 = avg_rating_of_rating(rating1)
        avg_rating2 = avg_rating_of_rating(rating2)
        self.assertEqual(avg_rating1, 1)
        self.assertEqual(avg_rating2, 3)
...
class test_views(TestCase):
    def setUp(self):
        ...
        #            "BMW":{'K1', '535i/535is'}}
        # self.test_makes_models={"Volkswagen":{'Euro Van','New Jetta'}}
    ...
    def test_adding_cars(self):
        ...
        print(
            "It can take some time because of accessing the web page, press ctrl+c to terminate"
        )
